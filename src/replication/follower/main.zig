...
pub const Follower = struct {
    ...
    pub fn handleReplicateRequest(
        ...
        return request_handlers.handleReplicateRequest(self.log, &self.commit_index, req);
    }
    ...
    pub fn handleHeartbeat(
        ...
        return request_handlers.handleHeartbeat(self.log, &self.commit_index, &self.last_heartbeat_ms, req);
    }
